...
extern const struct EWAlarmItemAttributes {
	...
	__unsafe_unretained NSString *ewalarmitem_id;
...
@property (nonatomic, strong) NSString* ewalarmitem_id;



//- (BOOL)validateEwalarmitem_id:(id*)value_ error:(NSError**)error_;
...
- (NSString*)primitiveEwalarmitem_id;
- (void)setPrimitiveEwalarmitem_id:(NSString*)value;
