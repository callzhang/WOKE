...
/** The general styling configuration for the whole chart.
 ...
 A ShinobiChart will take all of it's UI configuration - colors, line thicknesses, etc - from the SChartTheme object. The chart can be initially created with a theme - see initWithFrame:usingTheme:.  If a theme is not explicitly set on a chart, this property will be set to the SChartLightTheme by default.
 
 After this, changes made to individual objects will have precendence - for example setting the series color in the data source. To reset the styling configuration on a chart to a theme, alloc a new theme and set this property - this will clear all styling configuration from the chart and set it to the theme defaults. */
@property (nonatomic, retain) SChartTheme *theme;


/** Apply the current chart theme to the chart
 
 This applies the styling properties of the current theme to the chart, overwriting any changes which you have made to sub-objects on the chart.
*/
- (void)applyTheme;
