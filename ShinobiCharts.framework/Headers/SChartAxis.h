...
/** Returns the difference in data terms between where the data is drawn to it's value on this axis.
 ...
 */
-(id)offsetForDataValue:(id)data inSeries: (SChartSeries *)series;
