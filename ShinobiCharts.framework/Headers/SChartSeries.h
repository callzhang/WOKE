...
- (id)centreXOfDataPointAtIndex:(int)index onChart:(ShinobiChart *)chart;

/** Returns, in data terms, the y component of the point upon which the datapoint at the given index is centered. */
- (id)centreYOfDataPointAtIndex:(int)index onChart:(ShinobiChart *)chart;

/** Returns the width, in data terms, of the datapoint at the given index. */
- (id)widthOfDataPointAtIndex:(int)index onChart:(ShinobiChart *)chart;

/** Returns the width, in data terms, of the datapoint at the given index. */
- (id)heightOfDataPointAtIndex:(int)index onChart:(ShinobiChart *)chart;
